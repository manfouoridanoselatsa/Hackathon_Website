            ...
            <div class="form-group">
              ...
              <div class="form-check form-check-inline">
				...
				<div class="form-group" style="margin-top: 25px;">
					<div class="form-label fst-italic font-weight-bold" style = "text-align : center;">
					*Expliquez le choix(Entrez juste les mots clés) :<br/> <span class="required error fst-italic" id="text_expli" style = " font-size : 11px;"></span>
				</div>
...
$("#exampleRadios3").on("click",function(){
		$("#explication").hide();
		$("#text_expli").html("Veillez remplir").css("color", "#ee0000").hide();
});
...
function VoteValidation() 
{
  ...
  if (!vote) {
    ...
    $("#text_vote").html("Veillez choisir").css("color", "#ee0000").show();
		valid = false;
	...
	if (Text.trim() == "" && vote != 2) {
		...
		$("#text_expli").html("Veillez remplir").css("color", "#ee0000").show();
		valid = false;
	}
	if (valid == false) {
